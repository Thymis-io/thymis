...
Artifacts should not be used for secrets or sensitive data. For sensitive data, use the **Secrets** feature instead, which provides secure storage and access control.
