...
- **SSH public key**: Add your SSH public key to the Security & Access module for the device’s configuration in the Thymis UI.
...
- Adding your key to the Security & Access module makes it available to all devices using that configuration.
