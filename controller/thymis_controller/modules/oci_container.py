...
class OCIContainers(modules.Module):
    ...
    containers: models.Setting = models.Setting(
        ...
        type=models.ListType(
            settings={
                ...
                "ports": models.Setting(
                    ...
                    type=models.ListType(
                        ...
                        add_element="oci-containers.containerSettings.addPort",
                        remove_element="oci-containers.containerSettings.removePort",
                    ),
                    default=[],
                ...
                "volumes": models.Setting(
                    ...
                    type=models.ListType(
                        ...
                        add_element="oci-containers.containerSettings.addVolume",
                        remove_element="oci-containers.containerSettings.removeVolume",
                    ),
                    default=[],
                ...
                "environment": models.Setting(
                    ...
                    type=models.ListType(
                        ...
                        add_element="oci-containers.containerSettings.addEnvironment",
                        remove_element="oci-containers.containerSettings.removeEnvironment",
                    ),
                    default=[],
                ...
                "labels": models.Setting(
                    ...
                    type=models.ListType(
                        ...
                        add_element="oci-containers.containerSettings.addLabel",
                        remove_element="oci-containers.containerSettings.removeLabel",
                    ),
                    default=[],
            ...
            add_element="oci-containers.addContainer",
            remove_element="oci-containers.removeContainer",
        ),
        default=[],
