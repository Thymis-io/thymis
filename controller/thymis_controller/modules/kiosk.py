...
class Kiosk(modules.Module):
    ...
    def write_nix_settings(
        ...
        f.write(
            ...
            exec ${{pkgs.bash}}/bin/bash -c "rm -rf ~/.config/chromium/Singleton*; ${{pkgs.chromium}}/bin/chromium --kiosk '{kiosk_url}' ${{"--disable-gpu" if (pkgs.stdenv.system == "aarch64-linux") else ""}}"
