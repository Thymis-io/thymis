...
class Repo:
    ...
    def commit(self, summary: str, notification_manager: NotificationManager):
        self.stage_all()
        self._commit(summary)
        self.pull(notification_manager)
        self.push(notification_manager)

    def push(self, notification_manager: NotificationManager):
        try:
            self.repo.git.push()
    ...
    def fetch_all(self, notification_manager: NotificationManager):
        try:
    ...
    def history(self, notification_manager: NotificationManager):
        try:
            with history_lock:
